				...
				<div class="productList">
						...
						<div class="plist" id="plist">
							<div>
				            	...
				            	<c:forEach var="hashtag" items="${fn:split(list.hashtag,'#')}" end="1">
				            	...
				            	<c:forEach var="hashtag" items="${fn:split(list.hashtag,'#')}" begin="2" end="3">
				            		<a href="hashtagList?keyword=${hashtag}">
				            			<span class="hashtagsplit"> #${hashtag}</span>
				            		</a>
				            	</c:forEach>
				            	...
				            	<c:forEach var="hashtag" items="${fn:split(list.hashtag,'#')}" begin="4">
				            		<a href="hashtagList?keyword=${hashtag}">
				            			<span class="hashtagsplit"> #${hashtag}</span>
				            		</a>
				            	</c:forEach>
