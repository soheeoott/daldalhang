...
<head>
	...
	<!-- 
		발급받은 Naver Map API Client ID : 클라이언트 아이디 
		클라이언트 비동기 방식으로, 지정한 콜백 함수를 호출함 
	-->
	<script type="text/javascript" src="https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=클라이언트아이디&callback=initMap"></script>
