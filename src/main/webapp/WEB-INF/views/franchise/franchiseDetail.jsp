            	...
            	<div class="form">
            		<form action = "fcinsert" name="franchise" id="franchise" method = "post" enctype="multipart/form-data"> <!-- img [enctype="multipart/form-data"] -->
						<div class="input_box">
							...
							<input type= "text" name = "frcode" id = "frcode" value="${fdetail.frcode}">
						</div>
						
						<div class="input_box">
							<div class="explan">영문 이름</div>		
							<input type= "text" name = "frename" id = "frename" value="${fdetail.frename}">
						</div>
						
						<div class="input_box">
							<div class="explan">한글 이름</div>
							<input type= "text" name = "frkname" id = "frkname" value="${fdetail.frkname}">
						</div>
					
						<div class="input_box">
							<div class="explan">이벤트 등록 색상</div>		
							<!-- <input type= "color" name= "frcolor" id= "frcolor" class= "frcolor"> -->
							<input type='text' id="togglePaletteOnly" name= "frcolor" value="${fdetail.frcolor}"/>
						</div>
						...
						<div class="input_box">
							...
							<div class="filebox"> 
								...
								<input class="upload-name" value="파일선택" disabled="disabled" value="${fdetail.fruploadfile}">
								<input type="file" id="ex_filename" name="fruploadfilef" class="upload-hidden"> 
								<img src ="${fdetail.fruploadfile}" class="select_img"/>
							</div>
