	...
	$(function validate(){
	   ...
	   $("#id").blur(function() {
		...
		$("#email_domain").blur(function() {
			...
			$.ajax({
				url : '${pageContext.request.contextPath}/personal/emailCheck?email_id='+ email_id + '&email_domain=' + email_domain,
				type : 'get',
				success : function(data) {
					console.log("1 = 중복o / 0 = 중복x : " + data);
                ...
                <div>
                    ...
                    <section class="agreement"> <!-- mem_agreement_wrap -->
	                  ...
	                  <div class="input_box pw">
		                  	...
		                  	<div id="pw_check" class = "pw_check"></div>
	                  </div>
	                  ...
	                  <div class="input_box email">
	                  		...
	                  		<label>이메일</label>
									...
									<div id="email_check" class="email_check"></div>
