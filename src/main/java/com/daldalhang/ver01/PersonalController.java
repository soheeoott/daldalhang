...
public class PersonalController {
	...
	public ModelAndView join(ModelAndView mv, PersonalVO vo) {
		
		mv.setViewName("personal/doFinish");
	...
	public ModelAndView loginf(ModelAndView mv) {
		mv.setViewName("personal/naverlogin");
		return mv;
	}
	
	@RequestMapping(value = "/login")
	public ModelAndView login(HttpServletRequest request, ModelAndView mv, PersonalVO vo) {
